...
```text
โจทย์ให้หาว่าราคาของที่ส่งราคากี่บาท

Input : บรรทัดแรก พัสดุต้นทาง พัสดุปลายทาง บรรทัดที่สอง น้ำหนักของพัสดุ
Output : ราคาขนส่ง
Constrains : ถ้าเส้นทางไม่อยู่ในที่กำหนด ให้แสดงผล ERROR
```
...
```text
Step 1: อ่านต้นทาง ปลายทาง
Step 2: อ่านค่าน้ำหนัก
Step 3: หาค่าขนส่ง
```
...
```text
วิธีสุดท้ายเหมือนตัวแรก คือใช้if else ในการตรวจสอบต้นทางกับปลายทางในแต่ละราคาเลย
```
...
```text
เพื่อดูว่าถูกหรือไม่และทศนิยมถูกหรือไม่
```
...
```text
ถ้าผ่านเทสเคสแสดงว่ามีโอกาสpass
```
