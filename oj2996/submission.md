...
โจทย์ให้รับข้อความมา5ตัว แล้วให้สลับตัวอักษร และเป็นตัวพิมพ์เล็ก

input : โปรแกรมรับตัวอักษร 5 อักขระ

output : ตัวอักขระหลังสุดมาอยู่ตัวแรก สลับเรื่อยๆ และเป็นตัวพิมพ์เล็ก

constraints : Input มี 5 อักขระ จึงพิจารณาเมื่อมีน้อยกว่า 5 อักขระ
...
```text
Step 1:อ่านอักขระ
Step 2:ตรวจสอบครบ 5 ตัวหรือไม่
Step 3:ถ้าครบ สลับอักขระ เป็นตัวพิมพ์เล็ก
step 4:ถ้าไม่ครบ บอกว่าอักขระไม่ครบ
```
...
วิธีสุดท้ายเหมือนแผนแรก คือ เช็คก่อนว่าครบ 5 อักขระหรือไม่ จึงค่อยเปลี่ยนสลับอักขระ และเป็นตัวพิมพ์เล็ก
...
สลับตัวพิมพ์ใหญ่กับพิมพ์เล็กไปมา
...
| If I received human help, I disclosed it in this file. |yse |
