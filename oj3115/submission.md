...
```text
เช็คว่าเวลาที่ให้มา ยังมีร้านไหนเปิดอยู่บ้าง
Input : จำนวนร้าน และจำนวนเวลาที่ต้องการให้เช็ค 
Output : ณ เวลานั้นมีร้านไหนเปิดอยู่บ้าง
Constrains : ร้านจะปิดก่อนเวลา 1 นาที
```
...
```text
Step 1 : อ่านจำนวนเต็ม num และ check
Step 2 : รับค่าเวลาเปิดและปิด ตามจำนวน num
Step 3 : รับค่าเวลาที่ต้องการเช็ค ตามจำนวน check
Step 4 : เช็คว่าในเวลาที่ให้มา ยังอยู่ในช่วงเวลาเปิดปิดของแต่ละร้านหรือไม่
```
...
```text
ใช้วิธีเดียวกับวิธีแรก คือใช้ลูปในการเช็คทีละร้าน ทีละช่วงเวลาที่ต้องการให้เช็ค
```
