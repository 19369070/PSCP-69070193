...
```text
โจทย์จะให้ความหนาของแถบ และจำนวนช่องมา ให้หาว่าช่องสุดท้ายอยู่แถบไหน

Input : ความหนาแถบ (L) จำนวนช่อง(N)
Output : แถบที่ช่องสุดท้ายอยู่
Constrains : ค่า n ค่อนข้างมาก
```
...
```text
Step 1: รับค่า L และ N
Step 2: กำหนดค่าแถบเป็น 1
Step 3: ใช้ while loop ในการวนจนกว่า ค่า N จะมากกว่า แถบ
Step 4: กำหนดค่า n ใหม่ จากการนำ n-แถบ
Step 5: กำหนดค่า แถบใหม่ จากการนำแถบไปบวก 1
Step 6: หลังจากนั้นนำแถบที่ได้ไปหา l และปัดเศษขึ้น 
```
...
```text
วิธีสุดท้ายที่ใช้เหมือนวิธีแรกเลย เพราะใช้ while loop อยู่แล้ว ทำให้ไม่มีปัญหาการใช้เวลาเยอะเกิน
```
...
```text
ทดสอบความเข้าใจว่าที่เข้าใจถูกต้องหรือไม่
```
...
```text
ทดสอบว่าถ้าแถบไม่ได้เป็น 1 ค่าที่ออกมาเป็นอะไร
```
