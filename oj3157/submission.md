...
```text
หาคะแนนสุดท้าย โดยจะเริ่มจาก 0 ถ้า + ขะเพิ่มไป 10 ถ้า - จะลบไป 5
Input : จำนวนที่ต้องการใส่ข้อมูล 
Output : คะแนนรวมสุดท้าย
Constrains : เป็นจำนวนเต็ม
```
...
```text
Step 1: รับค่าจำนวนเครื่องหมาย (N)
Step 2: รับค่าเครื่องหมาย + หรือ - 
Step 3: ถ้าเป็น + ให้บวก 10
Step 4: ถ้าไม่ใช่ให้ -5
Step 5: แสดงคะแนนรวมในรอบสุดท้าย
```
...
```text
ใช้เหมือนวิธีแรก คือรับเครื่องหมายเข้ามาแล้วไปบวก ลบ เลย
```
