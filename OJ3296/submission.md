...
```text
โจทย์ให้รับระบบสีมาสองสีที่แทนด้วย R G B หลังจากนั้นให้หาสีที่เกิดใหม่ซึ่งหาได้จากการหาค่าเฉลี่ย 

Input : รับค่าระบบสี 2 บรรทัด
Output : สีใหม่ที่เกิดจากค่าเฉลี่ย
Constrains : ค่าเฉลี่ยที่ออกมาจะเป็นจำนวนเต็ม เพราะระบบสีไม่มีทศนิยม
```
...
```text
Step 1: อ่านระบบสี 2 สี
Step 2: ใช้ for loop วนโดยการนำสีแต่ละอันมาบวกกันแล้วหาร 2
Step 3: เก็บไว้ในลิส
Step 4:แสดงค่าเฉลี่ยของแต่ละสี
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก ใช้for loopในการวนลูป หลังจากนั้นค่อยเก็บไว้ใน list
```
...
```text
ดูว่าผลลัพธ์ออกมาเป็นจำนวนเต็มหรือไม่
```
