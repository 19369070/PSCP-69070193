...
```text
เดือนที่ 1-3 จะเป็นฤดูหนาว เดือนที่ 4-6 จะเป็นฤดูใบไม้ผลิ เดือนที่ 7-9 จะเป็นฤดูร้อน เดือนที่ 10-12 จะเป็นฤดูใบไม้ร่วง  แต่ถ้าตั้งแต่วันที่ 21 และเดือนหาร 3 ลงตัว ฤดูจะถัดไปอีก 1 ฤดู เช่น วันที่ 22 เดือน 3 จะได้ฤดู ใบไม้ผลิ

Input: เดือน กับ วันที่ 

Output: ฤดู

Constraints: ตั้งแต่วันที่ 21 และเดือนหาร 3 ลงตัว ฤดูจะเลื่อนไปอีก 1 ฤดู แต่ถ้าเดือนนั้นหาร 3 ไม่ลงตัว ก็จะเป็นฤดูนั้น 
```
...
```text
Step1: อ่านเดือน กับวันที่
Step2: ตรวจว่าวันที่ เลยวันที่ 21 หรือไม่
Step3: ถ้าจริงให้พิมพ์ตามฤดู
Step4: ถ้าไม่จริง ให้ตรวจสอบว่า เลยวันที่ 21 และเดือนหาร 3 ลงตัวหรือไม่
Step5: ถ้าจริงให้พิมพ์ตามฤดูที่ถัดไปอีกหนึ่ง
```
...
```text
ตรวจสอบก่อนว่าอยู่ในช่วงวันที่ 21-31 และ เดือนคือเดือน 3 6 9 และ12 ถ้าใช่จะแสดงฤดูที่ถัดไปอีกหนึ่ง แต่ถ้าเป็นวันที่ 1-31 จะขึ้นตามฤดู
```
...
```text
เพราะวันที่ 10 น้อยกว่า วันที่ 21
```
...
```text
เลยวันที่ 21 แต่เดือนหาร 3 ไม่ลงตัว
```
