...
| OJ submission ID, if submitted | 588689 |
| OJ status | Pass |
...
```text
ให้ เอไออธิบายโจทย์ ว่าคือยังไง หลักจากนั้นถามจากที่ฉันเข้าใจว่าถูกหรือไม่
```
...
```text
ช่วยให้เห็นการวิเคราะห์โจทย์ว่าบางประโยคมันมีอะไรมากกว่าที่คิด
...
```text
เห็นการปัดทศนิยมว่าต้องปัดลงเสมอ จึงแก้จากการใช้ :.0f เป็น math.ceil()
```
...
```text
เรียนรู้ว่าการปัดเศษในแต่ละแบบมีความสำคัญ แล้วแต่ว่าเราจะใช้แบบไหน ปัดลงหมด ปัดขึ้นหมด และต้องระวังคือ .5 ที่จะปัดยังไง
```
