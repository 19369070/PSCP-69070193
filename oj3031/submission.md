...
```text
จะมีน้ำหมึกตกลงมา และทุกๆ1วินาทีน้ำหมึกจะขยายออกไป S ตารางหน่วย ซึ่งรอบๆจะมีบ้านคน อยากรู้ว่าจะโดนบ้านเขาที่วินาที่เท่าไหร่

Input : s กับจำนวนบ้าน
Output : วินาทีที่โดนบ้าน
Constrains : ถ้ามีทศนิยมให้ปัดขึ้น
```
...
```text
Step1:อ่านค่าจำนวนบ้านที่รับเข้าพร้อมกับ1วินาทีขยายไปเท่าไหร่
Step2:รับค่าพิกัดของบ้านแต่ละหลังใส่ใน list
Step3:แล้วเอาพิกัดแต่ละอันมาคำนวณ
Step4:แสดงค่าวินาทีที่น้ำหมึกจะถึงออกมาโดยปัดทศนิยมขึ้น
```
...
```text
ตอนแรกใช้การเช็คว่าถ้าเศษไม่เท่ากับ1ให้บวกเพิ่มไปอีก1 แต่พอเอาไปเทสเคสผ่านแค่เทสเคสเดียว ก้เลยเปลี่ยนมาใช้ math ceil แทน
```
