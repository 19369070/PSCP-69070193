...
| OJ submission ID, if submitted | 566542 |
| OJ status | Pass |
...
```text
ช่วยดู bug และให้ช่วยเสนอ test case 
```
...
```text
ได้เห็นว่าตัวเองผิดตรงไหนและยังคิดตื้นเกินไป ฝึกแนวคิดมุมกว้างๆ
...
```text
กลับไปตรวจว่าเลขตรงกลางไม่จำเป็นต้องห่างจากเลขมากสุดแค่ 0.1 
```
...
```text
ได้เรียนรู้ว่า ถ้าผลรวมตัวเลขที่เหลือสองตัวน้อยกว่าค่าสูงสุด ค่าต่ำสุดจะเป็น 0
```
