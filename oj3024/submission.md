...
```text
โจทย์ให้ผลรวมของเลขสามตัวและค่าสูงสุดมา แล้วดูว่ามีเลขห่างกันแปลกๆมั้ย
...
Output:
ถ้าเลขสูงสุดกับต่ำสุดห่างเกิน 2 พิมพ์ Surprising ไม่งั้นพิมพ์ Not surprising

Constraints:
เลขทั้งสามตัวต้องมากกว่า 0 แต่ไม่เกิน 10
```
...
```text
Step 1: อ่านค่าผลรวม อ่านค่ามากที่สุด
Step 2: หาค่าตัวที่สอง โดยนำค่าสูงสุด-0.1
Step 3: หาค่าตัวที่สาม โดยนำผลรวม-สูงสุด-ตัวที่สอง
Step 4:ตรวจว่าค่าสูงสุดลบค่าต่ำสุด <= 2 หรือไม่
Step 5:ถ้าจริง ให้พิมพ์ "Not surprising"
Step 6:ถ้าไม่จริง ให้พิมพ์ "Surprising"
```
...
```text
วิธีสุดท้ายมีวิธีแรกเหลือแค่ตรงดูว่าน้อยกว่าเท่ากับสองหรือไม่ ในส่วนของการคิด ดูแค่ค่ามากสุดและผลรวม หลังจากนั้นหาค่าน้อยสุดได้เลย
```
...
```text
คะแนนที่เหลือรวมกันมากกว่าค่าสูงสุด
```
...
```text
คะแนนที่เหลือรวมกันไม่เกินค่าสูงสุด
```
...
```text
ช่วยเตือนว่าค่าต้องไม่ติดลบ ช่วยอธิบายโจทย์อีกรอบ
ช่วยบอกว่าทำไมต้องคูณ 2
```

คุณยังทำอะไรด้วยตนเอง

```text
ส่ง OJ ด้วยตนเองทั้งหมด และยังเขียน code เอง
```
