...
```text
โจทย์ให้เปลี่ยนหน่วยอุณหภูมิ 

Input:
รับค่าอุณหภูมิ (จำนวนจริง)
หน่วยอันแรก
หน่วยอันที่สองที่ต้องการเปลี่ยน

Output:
อุณภูมิที่มีหน่วยเป็นค่าที่สองที่รับเข้ามา

Constrains: 
คำตอบต้องเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: อ่านค่าอุณหภูมิ 
Step 2: อ่านค่าหน่วยอันแรก
Step 3: เปลี่ยนเป็นองศาเซลเซียส
Step 4: อ่านค่าหน่วยอันที่สอง (หน่วยที่ต้องการให้เปลี่ยน)
Step 5: เอาค่าที่เป็นหน่วยองศาเซลเซียสมาคำนวณ ให้ตามหน่วยที่ต้องการเปลี่ยน
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก คือ เปลี่ยนเป็นองศาเซลเซียสก่อนแล้วค่อยเปล๊่ยนไปหน่วยต่างๆ
```
