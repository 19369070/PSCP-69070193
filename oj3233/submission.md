...
```text
โจทย์ให้หาว่าจะได้รับเงินจากการถูกฉลากเงินรางวัลกี่บาท 
Input : ผลของฉลากรางวัล และรางวัลที่ซื้อ
Output : จำนวนเงิน
Constrains : มีรางวัลสูงสุดเพียงรางวัลเดียว
```
...
```text
Step 1: รับค่าฉลากทั้งสอง
Step 2: นำมาตรวจสอบว่าเข้าเงื่อนไขข้อไหน
Step 3: ถ้าไม่เข้าเงื่อนไข ให้แสดงผลลัพธ์เป็น 0
```
...
```text
ใช้เหมือนวิธีแรก แต่ติดตรงใช้เงื่อนไขเกิน
```
...
```text
เพื่อดูว่าถ้าไม่ตรงเงื่อนไขจะต้องขึ้น 0
```
...
```text
เพื่อดูว่าใส่เลข 0 เกินหรือไม่
```
