...
```text
ให้หาจำนวนเฉพาะจากตัวเลขในช่วงที่กำหนด
Input : จำนวน 2 จำนวน
Output : จำนวนเฉพาะ พร้อมจำนวน
Constraints : เอาตั้งแต่ตัวเริ่มต้น ยันตัวสุดท้าย
```
...
```text
Step 1: รับค่าตัวเลขเริ่มต้น และตัวเลขตัวสุดท้าย
Step 2: เช็คว่าตัวเลขหาร2 3 5 7ลงตัวหรือไม่
Step 3: ถ้าหารลง ให้ เพิ่มเข้าลิสต์ และนับ
Step 4: แสดงตัวในลิส และจำนวนตัวที่เป็นจำนวนเฉพาะ
```
...
```text
วิธีสุดท้ายคือต้องดักเพิ่มเติม อันนั้นยังทำชั้นเดียว ทำให้ใช้ได้แค่ตัวเลข1 -10
```
...
```text
เป็นตัวเลขที่ง่ายต่อการตรวจสอบ
```
...
```text
ช่วยบอกว่ามันจะมีอีดชั้นนึง ให้ดักไว้
```
