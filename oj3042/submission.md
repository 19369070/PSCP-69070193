...
```text
โจทย์ให้รับเลขมา 1 ตัว ตั้งแต่เลขนั้นจนถึง 0 ให้แสดงเลขที่หาร 10 ลงตัว

Input: เลขจำนวนเต็มบวก
Output: เลขที่หาร 10 ลงตัว
Constraints: สิ้นสุดที่ 0 แสดงว่าที่แสดงออกมาต้องไม่มีติดลบ
```
...
```text
Step 1: อ่านจำนวนเต็ม num
Step 2: เก็บค่าตั้งแต่ 0 ถึง num  ที่หาร 10 ลงตัว ลงใน X (list)
Step 3: สลับเลขจากหลังมาหน้า  
```
...
```text
วิธีสุดท้ายไม่เหมือนกับแผนแรก เพราะจากการรับค่าเข้ามา ต้องเอาค่านั้นไปบวกเพิ่มอีก 1 เพื่อให้ได้นับค่านั้นด้วย
```
