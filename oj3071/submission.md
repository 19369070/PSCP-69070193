...
```text
หาจำนวนในช่วงจากปิด A ถึงปิด B ว่าตัวไหนหารด้วย d แล้วเหลือเศษ r

Input : ช่วงปิดAและB ตัวหารd และเศษr
Output : จำนวนที่หารdแล้วเหลือเศษr
Constrains : เริ่มที่A
```
...
```text
Step1:รับค่าA B d r
Step2:ใช้ for วนลูปตรวจว่าเมื่อหาร d แล้วเหลือเศษ r หรือไม่
Step3:ถ้าใช้ให้นับไป1ครั้ง
```
...
```text
ใช้while loopเพราะพอทำแล้วไม่ได้เริ่มที่ A แต่เริ่มจาก 0 แต่หลักการคิดเหมือนกันเลย
```
...
```text
ตรวจว่าถ้าไม่มีที่ตรงเลยจะขึ้นอะไร
```
