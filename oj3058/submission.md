...
```text
Input : จำนวนอิฐก้อนเล็ก ก้อนใหญ่ ความยาวสะพาน
Output : จำนวนอิฐก้อนเล็ก
Constrains : ถ้าจำนวนที่ใช้อิฐก้อนเล็กมากกว่าจำนวนที่รับเข้ามา ให้แสดง -1
```
...
Step 2: ใช้ for วนลูป หาจำนวนที่มากสุดของ b
Step 3: เมื่อได้ค่าออกมานำมาหาค่า a
```
...
```text
ไม่เหมือนเลย เพราะใช้เวลาเยอะเกิน จึงนำมาหารปัดเศษทิ้ง หลังจากนั้นจึงหา a โดยการ ถ้าจำนวนaที่ต้องใช้มากกว่าที่รับเข้ามาให้แสดง -1 แต่ถ้าไม่ก็แสดงค่า a ปกติ
```
