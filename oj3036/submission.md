...
```text
หาทางที่น้อยที่สุดที่จะทะลุไปถึงห้องหมายเลข 1 โดยใช้การพังกำแพงไปเรื่อยๆ

Input : ห้องที่อยู่
Output : จำนวนกำแพงที่พัง
Constrains : ถ้าเป็นเลขคู่ จะต้องลดไป 1 แต่ถ้าเป็นเลขคี่จะลดไป 2
```
...
```text
Step 1: เมื่อรับค่าห้องเข้ามาแล้ว หาชั้นที่ห้องนั้นอยู่
Step 2: เมื่อได้ชั้นแล้ว หาห้องว่าว่างกี่ห้อง
Step 3: หาห้อง
Step 4: ถ้าห้องที่เหลือเป็นเลขคู่ ให้ -1
Step 5: แต่ถ้าไม่ใช่ให้ -2
```
...
```text
เหมือนวิธีแรก แต่มาดูตรงเป็นเลขคู่ เลขคี่ว่าต้องลบเท่าไหร่
```
...
```text
ช่วยบอกใบ้ว่า ในแต่ละแถวจะเป็นกำลังสองนะ
และถ้าห้องนั้นเป็นเลขคู่ หรือเลขคี่
```
