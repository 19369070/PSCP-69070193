...
```text
มีกี่คนที่ไดเพิจารณาของขวัญ จนกระทั่งของขวัญวนกลับมาที่คนที่ 1 หรือ อยู่ที่ขโมย ขโมยจะวิ่งหนีทันที
Input : จำนวนคนที่นั่งเป็นวง(N) ส่งให้(K)คน คนที่(T)คือขโมย
Output : จำนวนรอบ
Constrains : ถ้าคนแรกเป็นขโมย ได้แค่ 1 รอบ
```
...
```text
Step 1: อ่านจำนวนเต็ม N K T
Step 2: ใช้ลูปในการวนหา
Step 3: ถ้านำ 1 + K แล้วเกิน  N ให้นำไปลบ N ก่อน 
Step 4: ถ้า 1 + K ไม่เท่ากับ 1 และ ไม่เท่ากับ T ให้นับ 1 
Step 5: ถ้าเท่ากับ 1 ให้ออกนอกลูป
Step 6: ถ้าเท่ากับ T ให้บวก 1 แล้วค่อยออกจากลูป
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก คือใช้การหาตำแหน่งคนก่อนหลังจากนั้นจึงไปเช็คว่าตรงกับขโมยหรือตรงกับคนที่ 1 หรือไม่ ถ้าตรงให้หยุดนับ
```
