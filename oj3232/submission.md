...
```text
โจทย์ให้หาจำนวนครั้งที่กบจะกระโดดได้(y) โดยจะเริ่มจากรอบ(x) และลดลงทีละ 2

Input : จำนวนระยะทางรอบแรกที่กระโดดได้ ระยะทางทั้งหมด
Output : กระโดกี่ครั้งจึงไปถึง
Constrains : ถ้าไปไม่ถึงให้พิมพ์ -1
```
...
```text
Step 1: อ่านค่า x y
Step 2: นำค่า x มาวนลูปจนกว่าจะถึง y
Step 3: ถ้า i ไม่เท่ากับ 0 ให้นับค่า+1 และนำค่าเข้าลิส
Step 4: ถ้าค่าที่นับ มากกว่าเท่ากับ y หรือ x เท่ากับ 0
Step 5: ให้หยุดการทำงาน
Step 6: ถ้า x น้อยกว่า 0 ให้เอาค่าในลิสออก หลังจากนั้นค่อยหยุดการทำงาน
Step 7: ถ้าค่าผลรวมมากกว่า y ให้แสดงค่าที่นับ
Step 8: ถ้าน้อยกว่าให้แสดง -1
```
...
```text
เหมือนวิธีแรก แต่พอมาอ่านใหม่จริงๆไม่ต้องใช้ลิสก็ได้
```
...
```text
เพื่อดูว่าตามที่เข้าใจเข้าใจถูกแล้วหรือไม่
```
...
```text
ถ้าเริ่มที่ 0 ไม่มีให้ลดจะเป็นอย่างไร
```
