...
```text
รับค่าคำเข้ามา แล้วดูว่าสระแต่ละตัว มีจำนวนเท่าไหร่

Input : รับค่าคำ
Output : จำนวนสระแต่ละตัว
Constrains : ถ้าไม่มีสระนั้นไม่ต้องแสดง และเป็นตัวพิมพ์ใหญ่กับพิมพ์เล็ก
```
...
```text
Step1 : รับค่าคำเข้ามา
Step2 : ใช้For Loopเช็คว่าแต่ละตัวมีสระเท่าไหร่
Step3 : ถ้าแต่ละตัวมีค่ามากกว่า 0 ให้แสดงตัวอักษรนั้น
```
...
```text
ใช้เหมือนแผนแรก คือ เก็บจำนวนสระก่อน แล้วค่อยไปแสดงผลทีหลัง โดยต้องมากกว่า 0 ถึงจะแสดงออกมา
