...
```text
โจทย์ให้นำสี 2 สีจากแม่สี 3 สีมาผสมกัน 
Input : แม่สีสองสี

Output : สีที่ผสมระหว่างแม่สีสองสี

Constraints : แม่สีสีเดียวกันสามารถผสมกันได้ 
```
...
Step 2: เช็คว่าทั้งสองสีอยู่ในแม่สีหรือไม่
Step 4: ถ้าจริง 
    Step 4.1: สีแดง กับ สีเหลือง ให้พิมพ์ "Orange"
    Step 4.2: จะได้ว่า สีแดง กับ สีน้ำเงิน ให้พิมพ์ "Violet"
    Step 4.3: จะได้ว่า สีเหลือง กับ สีน้ำเงิน ให้พิมพ์ "Green"
    Step 4.4: ถ้าสีเหมือนกัน ให้พิมพ์ สีนั้นออกมา
Step 5:ถ้าไม่จริง ให้พิมพ์ "Error"
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก เช็คว่าอยู่ในแม่สีหรือไม่ หลังจากนั้นจึงทำการผสมให้ได้สีออกมาแต่ละสี แต่ถ้าสีเหมือนกันผสมกันก็จะได้สีนั้น
```
...
```text
เป็นการตรวจสอบว่า ได้เขียนครบทุกกรณีหรือไม่ ถ้าไม่จะขึ้น Error
```
