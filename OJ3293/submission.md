...
```text
โจทย์ให้แสดง * รอบๆข้อความ ซึ่งจะมี 5 ข้อความ จำนวน * จะมีตามจำนวนของข้อความที่มากที่สุด

Input : ข้อความ 5 ข้อความ
Output : * เป็นสี่เหลี่ยมตามข้อความทั้ง 5 ข้อความ
Constrains : กรอบบรรทัดแรก จะมี * มากกว่าข้อความ 4 อัน
...
```text
Step 1: อ่านข้อความทั้ง 5 ข้อความ
Step 2: หาจำนวนข้อความที่มากที่สุด
Step 3: บรรทัดแรก แสดงจำนวน * ตามข้อความที่มากที่สุด และบวกไปสอง
Step 4: และบรรทัดต่อ ๆ ไป ให้แสดง * ในตัวแรก และตัวสุดท้ายของแต่ละบรรทัด ให้ตรงกับข้อความด้านบน 
```
...
```text
ใช้เหมือนวิธีแรก คือใช้การนับจำนวนตัวอักษรที่มากที่สุดก่อน หลังจากนั้นจึงใช้มาลบเพื่อให้แสดงช่องว่างตามด้วย * ตัวสุดท้าย
```
...
```text
ตรวจสอบว่าจำนวนที่มากที่สุดไม่ได้อยู่ตัวแรก
```
