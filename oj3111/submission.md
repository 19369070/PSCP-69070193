...
```text
โจทย์ให้แสดงจำนวนเงิน ถ้าเป็นสมาชิกจะได้ส่วนลด 5% แต่ถ้าไม่เป็นสมาชิก จะได้ส่วนบด 3% ถ้ายอดซื้อตั้งแต่ 500 ขึ้นไป
Input : จำนวนราคาที่ซื้อของแต่ละอย่าง
Output : จำนวนเงินที่ต้องจ่ายทั้งหมด
Constrains : ทศนิยม 2 ตำแหน่ง แบบปัดเศษมาตรฐาน
```
...
```text
Step 1 : อ่านตัวอักษร และจำนวนเต็ม n
Step 2 : วนรับค่าของที่ซื้อตามจำนวน n
Step 3 : เอาทุกค่าที่รับเข้ามาบวกกัน 
Step 4 : ถ้าตัวอักษรเป็น Y ให้จ่าย 0.95*ผลรวม
Step 5 : แต่ถ้าเป็นตัวอักษร N ให้ตรวจเช็คต่อว่า ตั้งแต่ 500 บาทขึ้นไปหรือไม่
Step 6 : ถ้าตั้งแต่ 500 ขึ้นไป จ่าย 0.97 ของราคาทั้งหมด
Step 7 : แต่ถ้าไม่เกิน ก็จ่ายจำนวนเท่าเดิม
Step 8 : ทำเป็นทศนิยม 1 ตำแหน่ง โดยการเอาราคาท้ายสุด ไปคูณ 100 หลังจากนั้นใช้math.ceilปัดเศษขึ้นแล้วคูณ100
```
...
```text
ใช้วิธีเดียวกับแผนแรก ใช้math.ceilในการปัดให้ตรงกับหลักการทศนิยม
```
...
```text
เพื่อเช็คการปัดทศนิยม และการคิดการลดราคา
```
...
```text
ถ้าเป็น 500 พอดีจะได้ส่วนลดมั้ย สำหรับกรณีที่ไม่ได้เป็นสมาชิก
```
