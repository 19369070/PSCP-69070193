...
```text
โจทย์ให้รับค่าตัวอักษรหรือตัวเลขมา(ตัวย่อ) หลังจากนั้นถ้าเป็นตัวเลขให้เอาเลขมาใส่ได้เลย ตามด้วย of จบด้วยชื่อเต็มของตัวอักษรตัวข้างหลังสุด แต่ถ้าเป็นตัวอักษร ก็จะเป็นชื่อเต็มตามด้วย of และชื่อเต็มของตัวอักษรอีกตัว

Input : โปรแกรมแปลงตัวย่อเป็นตัวเต็ม
Output : ชื่อเต็มของตัวอักษรสองตัว กั้นด้วย of
Constrains : เลข 1 จะมี 1 กับ 10
```
...
```text
Step 1: อ่านข้อความ 
Step 2: แปลงข้อความเป็นตัวพิมพ์ใหญ่ถ
Step 3: ใช้ dic ในการเก็บไพ่แต่ละตัว
Step 4: ถ้่าตัวแรกเป็นเลข 1 ให้ตรวจสอบว่าทั้งข้อความมีความยาวเท่าไหร่
Step 5: ถ้ามีสองตัว ให้แสดงเป็นเลข 1
Step 6: ถ้าไม่จริง ให้แสดงเป็นเลข 10
Step 7: หลังจากนั้นตรวจสอบว่า ถ้าอยู่ในเลข 23456789 ก็ให้ขึ้นตามเลขนั้นๆ
Step 8: ถ้าไม่ตรงเงื่อนไขด้านบน ให้ใช้ dic
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก แต่ต้องระวังตรงตัวพิมพ์ใหญ่หรือพิมพ์เล็ก เพราะโจทย์สามารถให้มาพิมพ์เล็กก็ได้ พิมพ์ใหญ่ก็ได้
```
...
```text
เป็นตัวเลข 1 และยังเป็นพิมพ์เล็ก
```
