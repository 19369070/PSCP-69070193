...
```text
หาจำนวนเงินที่ลูกค้าต้องจ่าย โดยมี ค่าอาหาร เครื่องดื่ม ค่าบริการ VAT

Input: เงินค่าอาหาร+เครื่องดื่ม

Output: จำนวนเงินที่รวมค่าอาหาร+เครื่องดื่ม+ค่าบริการ+VAT

Constraints: ถ้าค่าบริการไม่ถึง 50 บาท ร้านจะคิด 50 บาท ถ้าเกิน 1000 บาท จะคิด 1000 บาท
```
...
```text
Step 1: รับค่าอาหาร+เครื่องดื่ม
Step 2: คิดค่าบริการ (0.1 ของอาหารและเครื่องดื่ม)
Step 3: ตรวจสอบว่าค่าบริการอย่างน้อย 50 บาท แต่ไม่เกิน 1000 บาท
    Step 3.1: ถ้าไม่เกิน 50 บาท คิดค่าบริการ 50 บาท
    Step 3.2: ถ้าเกิน 1000 คิดค่าบริการ 1000 บาท
Step 4: คิดค่า VAT7% จาก 0.07 ของ ค่าอาหาร+ค่าเครื่องดื่ม+ค่าบริการ
Step 5: ออกมาเงินที่ลูกค้าต้องจ่ายทั้งหมดในทศนิยม 2 ตำแหน่ง
```
...
```text
ใช้เหมือนแผนแรก คือ หาค่าบริการก่อน แล้วค่อยไปหาv VAT จากนั้นจึงเอาทั้งสองไปรวมกับค่าอาหารและเครื่องดื่ม 
```
...
```text
ค่าบริการอยู่ในช่วง 50-1000 บาท
```
